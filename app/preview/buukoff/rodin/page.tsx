...
// Page de comparaison Rodin (Hyper3D) vs Meshy UHQ.
// Modele 3D : /3d/dbz-trunks_rodin.glb (10 MB, ~90k triangles)
// vs /preview/buukoff qui charge /3d/dbz-trunks_uhq.glb (24 MB, ~595k triangles)
// Memes scene/lighting/effects pour comparaison juste.
...
const MODEL_PATH = "/3d/dbz-trunks_rodin.glb";
...
export default function BuuKoffRodinCompare() {
  const isMobile = useIsMobile();

  // Camera/scale adaptee figurine verticale (idem Buukoff)
    ...
    <div className="relative w-full h-screen bg-black overflow-hidden">
      ...
      <div className="absolute inset-0 z-30 pointer-events-none flex flex-col justify-between p-6 md:p-16">
        <div className="flex justify-between items-start">
          ...
          <span className="font-mono text-[10px] md:text-xs tracking-[0.3em] text-emerald-400">
            RODIN (90k tri)
          </span>
        </div>
        ...
        {isMobile ? (
          <div className="absolute top-20 left-6 right-6 flex flex-col gap-2">
            <span className="font-mono text-[9px] tracking-[0.4em] text-emerald-400/80 uppercase">
              Hyper3D Rodin · 10 MB
            </span>
            ...
            <p className="text-xs text-white/60 max-w-xs drop-shadow-lg">
              Test multi-engine benchmark.
              <br />
              Compare avec <a href="/preview/buukoff" className="text-emerald-400 underline pointer-events-auto">/preview/buukoff (Meshy UHQ)</a>
            </p>
          </div>
        ) : (
          <div className="flex flex-col items-start gap-4">
            <span className="font-mono text-[10px] tracking-[0.4em] text-emerald-400/80 uppercase">
              Hyper3D Rodin · 10 MB · 90k triangles
            </span>
            ...
            <p className="text-sm md:text-base text-white/50 max-w-md">
              Test multi-engine benchmark. Compare avec{" "}
              <a href="/preview/buukoff" className="text-emerald-400 underline pointer-events-auto">
                /preview/buukoff (Meshy UHQ, 24 MB, 595k tri)
              </a>
            </p>
          </div>
        )}
