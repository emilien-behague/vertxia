...
import { HeroIcosahedron } from "@/components/hero-icosahedron";
...
export default function VertxiaPage() {
  ...
  return (
    ...
    >
      ...
      {/* ───────────────────────────────── HERO ────────────────────── */}
      <section id="hero" className="relative min-h-screen flex flex-col justify-end px-6 md:px-10 pt-32 pb-12 overflow-hidden">
        {/* Icosaèdre 3D — transmission color piloté par useTimeOfDay (desktop only) */}
        <HeroIcosahedron />

        {/* Greeting time-aware */}
        <div className="relative z-10 font-fraktion text-[11px] tracking-[0.3em] uppercase mb-10" style={{ opacity: 0.55 }}>
          <span style={{ color: ACCENT }}>·</span> {greeting} {palette.label}, {timestamp}.
        </div>

        {/* Titre massif Bigger Display */}
        <h1
          className="relative z-10 font-bigger leading-[0.85] tracking-[-0.02em] mb-12"
          style={{
        ...
        <div className="relative z-10 max-w-3xl mb-10 grid md:grid-cols-12 gap-6">
